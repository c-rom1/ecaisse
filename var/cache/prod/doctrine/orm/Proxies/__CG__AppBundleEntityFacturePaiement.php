 ...
 */
class FacturePaiement extends \AppBundle\Entity\FacturePaiement implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\FacturePaiement' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\FacturePaiement' . "\0" . 'montant', '' . "\0" . 'AppBundle\\Entity\\FacturePaiement' . "\0" . 'facture', '' . "\0" . 'AppBundle\\Entity\\FacturePaiement' . "\0" . 'modePaiement'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (FacturePaiement $proxy) {
