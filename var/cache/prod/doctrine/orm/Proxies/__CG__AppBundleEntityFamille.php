 ...
 */
class Famille extends \AppBundle\Entity\Famille implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Famille' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Famille' . "\0" . 'code', '' . "\0" . 'AppBundle\\Entity\\Famille' . "\0" . 'libelle', '' . "\0" . 'AppBundle\\Entity\\Famille' . "\0" . 'tva'];
        }
