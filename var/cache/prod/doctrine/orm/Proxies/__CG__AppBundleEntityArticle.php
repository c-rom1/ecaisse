...
class Article extends \AppBundle\Entity\Article implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Article' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Article' . "\0" . 'code', '' . "\0" . 'AppBundle\\Entity\\Article' . "\0" . 'libelle', '' . "\0" . 'AppBundle\\Entity\\Article' . "\0" . 'prixUnitaire', '' . "\0" . 'AppBundle\\Entity\\Article' . "\0" . 'famille', '' . "\0" . 'AppBundle\\Entity\\Article' . "\0" . 'tva'];
        }
