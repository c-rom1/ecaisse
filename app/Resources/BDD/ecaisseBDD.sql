...
insert  into `famille`(`id`,`code`,`libelle`,`tva_id`) values (3,21454,'TESTEcvcv',1),(4,5,'gfhgfh',1);
...
insert  into `utilisateur`(`id`,`username`,`username_canonical`,`email`,`email_canonical`,`enabled`,`salt`,`password`,`last_login`,`confirmation_token`,`password_requested_at`,`roles`) values (2,'admin','admin','admin','admin',1,NULL,'$2y$13$wJgxs6D.eqxYPAqD20.Li.0ibDAFJW/V5ixz8O55M6QlRkHRq6542','2017-09-20 13:02:36',NULL,NULL,'a:0:{}');
